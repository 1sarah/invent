defmodule InventoryManagementWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {InventoryManagementWeb.Layouts, :root}
  ...
  scope "/" do
    ...
    forward("/graphql", Absinthe.Plug.GraphiQL,
      ...
      # socket: ExTmsWeb.TMSSocket,
      interface: :playground
    )

    # forward("/", Absinthe.Plug, schema: TppcExWeb.Schema)
  end

  scope "/", InventoryManagementWeb do
  ...
  if Application.compile_env(:inventory_management, :dev_routes) do
